...
class Translation {
  ...
  static Translation of(BuildContext context) => Localizations.of<Translation>(context, Translation)!;

  // Make english the default language
  Map<String, String> get stringValues {
    if(locale.languageCode == 'fr') return _localizedValues[locale.languageCode]!;
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'fr': {
      ...
      'send_bank_transfers_or_cash': 'Envoyer des virements bancaires ou des espèces',
      ...
      'entry_error_amount': 'Le montant saisi n\'est pas correct.\nIl doit être de la forme 00.00 ou 00,00',
    ...
    'en': {
      ...
      'entry_error_amount': 'Entered amount is not correct.\nIt must fit this format : 00.00 or 00,00',
  ...
  String get detailsOfTransaction => stringValues['details_of_the_transaction']!;
  ...
  String get sendBankTransfersOrCash => stringValues['send_bank_transfers_or_cash']!;

  String get createPot => stringValues['create_pot']!;

  String get supportAssociation => stringValues['support_association']!;

  String get noAdditionalTransactions => stringValues['no_additional_transactions']!;
