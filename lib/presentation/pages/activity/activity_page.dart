...
import 'package:grizbee/presentation/widgets/transactions/transaction_row.dart';
          ...
          switch (state.runtimeType) {
            case TransactionsFailure:
              InfoSnackBar.showErrorSnackBar(
                  context, (state as TransactionsFailure).message);
              break;
          }
        },
                    ...
                    return GestureDetector(
                      ...
                      onTap: () => {
                        Navigator.pushNamed(
                          ...
                          arguments: ActivityDetailsPageArguments(
                              transaction: transaction,
                              showSimilarTransactions: true),
                        )
                      },
                    );
                  });
