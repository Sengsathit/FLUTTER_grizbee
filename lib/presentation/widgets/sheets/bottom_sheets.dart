...
import 'package:grizbee/presentation/widgets/buttons/rounded_button.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            child:
                RoundedButton(title: firstTitle, backgroundColor: Colors.grey),
            onTap: () => {
              Navigator.pop(context),
              firstAction.call(),
            },
          ...
          GestureDetector(
            child: RoundedButton(
                title: secondTitle, backgroundColor: Colors.green),
            onTap: () => {
              Navigator.pop(context),
              secondAction.call(),
            },
