...
import 'package:grizbee/presentation/pages/activity/activity_details_page.dart';
import 'package:grizbee/presentation/pages/activity/activity_page.dart';
import 'package:grizbee/presentation/pages/activity/activity_similar_page.dart';
import 'package:grizbee/presentation/pages/info/info_page.dart';
import 'package:grizbee/presentation/pages/more/more_page.dart';
import 'package:grizbee/presentation/pages/payment/fund_payment_page.dart';
import 'package:grizbee/presentation/pages/scanner/scanner_page.dart';
import 'package:grizbee/presentation/pages/transfer/transfer_page.dart';
...
class BottomTabBarSectionNavigator extends StatelessWidget {
  BottomTabBarSectionNavigator(
      {required this.navigatorKey, required this.item});
      ...
      case RouteName.activity_details:
        return MaterialPageRoute(
            builder: (context) => ActivityDetailsPage(
                args: routeSettings.arguments as ActivityDetailsPageArguments));

      case RouteName.activity_similar:
        return MaterialPageRoute(
            builder: (context) => ActivitySimilarPage(
                args: routeSettings.arguments as ActivitySimilarPageArguments));

      case RouteName.funds_transfer:
        return MaterialPageRoute(
            builder: (context) => FundsTransferPage(
                args: routeSettings.arguments as FundTransferPageArguments));
